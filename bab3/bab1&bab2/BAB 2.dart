...
void main() {
  ...
  print("Harga setelah diskon produk2: ${produk2.harga}");
                   // Karyawan
  var karyawan1 = KaryawanTetap("Andi", umur: 30, role: Role.Manager);
  var karyawan2 = KaryawanKontrak("Budi", umur: 25, role: Role.NetworkEngineer);
  karyawan1.perbaruiProduktivitas(
      -10, karyawan1.role); // Update produktivitas untuk karyawan1
  print("Produktivitas Andi setelah penurunan: ${karyawan1.produktivitas}");
  // Perusahaan
  ...
  print(
      "Total Karyawan Non-Aktif: ${perusahaan.daftarKaryawanNonAktif.length}");
  // Proyek
  var proyek = Proyek();
